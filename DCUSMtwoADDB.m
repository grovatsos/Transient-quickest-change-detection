...
function [ add_Bcusum] = DCUSMtwoADDB( a0,b0,a1,b1, a2,b2,n,threshold_cusum,r)
...
for t=1:1:length(threshold)
  ...
  %          Z(1:(Gamma_1-1)) = normrnd(mu_0,s_d_0,1,Gamma_1-1);
        ...
        for k = 1:1:horizon
            ...
            else %max(subplus(log((normpdf(Z(k),mu_1,s_d_1))/(normpdf(Z(k),mu_0,s_d_0)))) ,
    ...
    BcusumADD(t)=mean(delay)

end

add_Bcusum=BcusumADD;
end
